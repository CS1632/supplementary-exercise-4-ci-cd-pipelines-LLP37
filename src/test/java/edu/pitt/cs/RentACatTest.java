...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		...
		assertNull("getCat(2) returns a cat when there are no cats", ret);
	}
	...
	public void testGetCatNumCats3() {
		...
		assertNotNull("getCat(2) returns null when there are 3 cats", ret);
	}
	...
	public void testCatAvailableFalseNumCats0() {
		...
		assertFalse("catAvailable(2) returns true when there are no cats.", ret);
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		assertTrue("catAvailable(2) returns false when cat 2 is available", ret);
	}
	...
	public void testCatAvailableFalseNumCats3() {
		...
		assertFalse("catAvailable(2) returns true when cat2 is rented", ret);
	}
	...
	public void testCatExistsFalseNumCats0() {
		...
		assertFalse("catExists(2) returns true when there are no cats", ret);
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		assertTrue("catExists(2) returns false with 3 cats", ret);
	}
	...
	public void testListCatsNumCats0() {
		// TODO
		String testL = r.listCats();
		assertEquals("No cats but listCats() returns non-empty string","", testL);
	...
	public void testListCatsNumCats3() {
		...
		r.addCat(c3);
		String testL = r.listCats();
		assertEquals("3 cats and listCats() does not return the expected string expected:","ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", testL);
	}
	...
	public void testRentCatFailureNumCats0() {
		// TODO
		boolean testRent = r.rentCat(2);
		assertFalse("No cats but rentCat(2) returns " + testRent,testRent);
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		r.addCat(c3);
		boolean testRent = r.rentCat(2);
		assertFalse("3 cats and cat 2 is rented but rentCat(2) returns " + testRent,testRent);
	}
	...
	public void testReturnCatFailureNumCats0() {
		...
		assertFalse("returnCat(2) returns true when there are no cats", ret);
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("returnCat(2) returns false when cat 2 is rented", ret);
